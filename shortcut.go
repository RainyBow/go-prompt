...
func Input(prefix string, completer Completer, in ConsoleParser, opts ...Option) string {
	pt := New(dummyExecutor, completer, in)
...
func Choose(prefix string, choices []string, in ConsoleParser, opts ...Option) string {
